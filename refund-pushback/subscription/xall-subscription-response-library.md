# X-All — Subscription Response Library (All Options)

Complete option library for the unified subscription pushback track. Each option is marked `ACTIVE` (currently deployed) or `RESERVE` (available for future use). For the deployment reference showing only active macros, see `xall-subscription-active-responses.md`.
...
> L2 buckets and macros pending. Will be populated when subscription track is built out.

---

# Layer 3+ — Retention Offers

> Retention offers and layer structure beyond L2 pending. Will be populated when subscription track is built out.
...
*X-All | Subscription — Response Library | March 2026*
