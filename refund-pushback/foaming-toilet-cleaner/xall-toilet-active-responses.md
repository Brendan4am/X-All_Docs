...
> All macros are intro-stripped. The formatting agent handles greetings, sign-offs, and personalization. Macros contain substance only. For the full option library, see `xall-toilet-response-library.md` in this folder.
